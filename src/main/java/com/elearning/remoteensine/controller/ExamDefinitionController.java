...
public class ExamDefinitionController {
    ...
    public String exibirPaginaRealizarProva(@PathVariable("idCurso") int idCurso,
    ...
    public String submeterProva(@PathVariable("idCurso") int idCurso,
                                @PathVariable("idDefinicaoProva") int idDefinicaoProva,
        ...
        try {
            ...
            Exam examSubmited = new Exam();
            examSubmited.setCourseId(idCurso);
            examSubmited.setIdExamDefinition(idDefinicaoProva);
            examSubmited.setStudentId(usuarioLogado.getIdUser());
            examSubmited.setGrade(notaFinal);
            examSubmited.setComment("Prova realizada em " + LocalDateTime.now().format(java.time.format.DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm")));
            examSubmited.setHourDate(LocalDateTime.now());
            examSubmited.setSubmitted(true);

            examService.saveStudentExamAttempt(examSubmited);
