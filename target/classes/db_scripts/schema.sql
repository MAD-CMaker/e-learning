...
-- INSERT INTO usuarios (nome, email, senha, tipo_usuario, especializacao) VALUES
-- ('Professor Admin', 'admin@ensinoremoto.com', 'senha_hasheada_admin', 'PROFESSOR', 'Administração do Sistema'),
-- ('Aluno Exemplo', 'aluno@exemplo.com', 'senha_hasheada_aluno', 'STUDENT', NULL);

-- INSERT INTO cursos (titulo, descricao, id_professor_responsavel, preco, categoria, carga_horaria) VALUES
...
-- INSERT INTO student_cursos (id_student, id_curso) VALUES
